"""Postgres connection pool, schema init, and seed data for the order-to-cash MCP server."""
...
load_dotenv()  # local dev only; Render injects env vars directly in production
